...
FROM mcr.microsoft.com/dotnet/sdk:8.0.416 AS dotnet-sdk-8
FROM mcr.microsoft.com/dotnet/aspnet:8.0.22 AS dotnet-aspnet-8
FROM mcr.microsoft.com/dotnet/runtime:8.0.22 AS dotnet-runtime-8
...
# ARG DOTNET_8_SHA_AMD64=
# ARG DOTNET_8_SHA_ARM64=
# # https://github.com/dotnet/dotnet-docker/blob/main/README.runtime.md#full-tag-listing
# ARG DOTNET_8_RUNTIME_VERSION=8.0.22
# ARG DOTNET_8_RUNTIME_SHA_AMD64=
# ARG DOTNET_8_RUNTIME_SHA_ARM64=
# # https://github.com/dotnet/dotnet-docker/blob/main/README.aspnet.md#full-tag-listing
# ARG ASPNET_8_RUNTIME_VERSION=8.0.22
# ARG ASPNET_8_RUNTIME_SHA_AMD64=
# ARG ASPNET_8_RUNTIME_SHA_ARM64=
...
FROM mcr.microsoft.com/dotnet/sdk:9.0.307 AS dotnet-sdk-9
FROM mcr.microsoft.com/dotnet/aspnet:9.0.11 AS dotnet-aspnet-9
FROM mcr.microsoft.com/dotnet/runtime:9.0.11 AS dotnet-runtime-9
...
# ARG DOTNET_9_SHA_AMD64=
# ARG DOTNET_9_SHA_ARM64=
# # https://github.com/dotnet/dotnet-docker/blob/main/README.runtime.md#full-tag-listing
# ARG DOTNET_9_RUNTIME_VERSION=9.0.11
# ARG DOTNET_9_RUNTIME_SHA_AMD64=
# ARG DOTNET_9_RUNTIME_SHA_ARM64=
# # https://github.com/dotnet/dotnet-docker/blob/main/README.aspnet.md#full-tag-listing
# ARG ASPNET_9_RUNTIME_VERSION=9.0.11
# ARG ASPNET_9_RUNTIME_SHA_AMD64=
# ARG ASPNET_9_RUNTIME_SHA_ARM64=

# # Install .NET 9 SDK
# #   See: https://github.com/dotnet/dotnet-docker/tree/main/src/sdk/8.0/bookworm-slim/amd64/Dockerfile
# #        https://github.com/dotnet/dotnet-docker/tree/main/src/sdk/8.0/bookworm-slim/arm64v8/Dockerfile
# RUN if [ "$(dpkg --print-architecture)" = "arm64" ]; then \
#   curl -SL --output dotnet.tar.gz https://dotnetcli.azureedge.net/dotnet/Sdk/${DOTNET_9_VERSION}/dotnet-sdk-${DOTNET_9_VERSION}-linux-arm64.tar.gz \
#   && echo "${DOTNET_8_SHA_ARM64} dotnet.tar.gz" | sha512sum -c - ; \
#   else \
#   curl -SL --output dotnet.tar.gz https://dotnetcli.azureedge.net/dotnet/Sdk/${DOTNET_9_VERSION}/dotnet-sdk-${DOTNET_9_VERSION}-linux-x64.tar.gz \
#   && echo "${DOTNET_8_SHA_AMD64} dotnet.tar.gz" | sha512sum -c - ; \
#   fi \
#   && mkdir -p /usr/share/dotnet \
#   && tar -oxzf dotnet.tar.gz -C /usr/share/dotnet ./packs ./sdk ./sdk-manifests ./templates ./LICENSE.txt ./ThirdPartyNotices.txt \
...
# # Install .NET 9 runtime (for STS tools)
# #   See: https://github.com/dotnet/dotnet-docker/tree/main/src/runtime/8.0/bookworm-slim/amd64/Dockerfile
# #        https://github.com/dotnet/dotnet-docker/tree/main/src/runtime/8.0/bookworm-slim/arm64v8/Dockerfile
# RUN if [ "$(dpkg --print-architecture)" = "arm64" ]; then \
#   curl -fSL --output dotnet.tar.gz https://dotnetcli.azureedge.net/dotnet/Runtime/${DOTNET_9_RUNTIME_VERSION}/dotnet-runtime-${DOTNET_9_RUNTIME_VERSION}-linux-arm64.tar.gz \
#   && echo "${DOTNET_8_RUNTIME_SHA_ARM64}  dotnet.tar.gz" | sha512sum -c - ; \
#   else \
#   curl -fSL --output dotnet.tar.gz https://dotnetcli.azureedge.net/dotnet/Runtime/${DOTNET_9_RUNTIME_VERSION}/dotnet-runtime-${DOTNET_9_RUNTIME_VERSION}-linux-x64.tar.gz \
#   && echo "${DOTNET_8_RUNTIME_SHA_AMD64}  dotnet.tar.gz" | sha512sum -c - ; \
#   fi \
#   && mkdir -p /usr/share/dotnet \
#   && tar -ozxf dotnet.tar.gz -C /usr/share/dotnet \
...
# # Install ASP.NET Core 9 runtime (for STS tools)
# #   See: https://github.com/dotnet/dotnet-docker/tree/main/src/aspnet/8.0/bookworm-slim/amd64/Dockerfile
# #   See: https://github.com/dotnet/dotnet-docker/tree/main/src/aspnet/8.0/bookworm-slim/arm64v8/Dockerfile
# RUN if [ "$(dpkg --print-architecture)" = "arm64" ]; then \
#   curl -fSL --output aspnetcore.tar.gz https://dotnetcli.azureedge.net/dotnet/aspnetcore/Runtime/${ASPNET_9_RUNTIME_VERSION}/aspnetcore-runtime-${ASPNET_9_RUNTIME_VERSION}-linux-arm64.tar.gz \
#   && echo "${ASPNET_8_RUNTIME_SHA_ARM64}  aspnetcore.tar.gz" | sha512sum -c - ; \
#   else \
#   curl -fSL --output aspnetcore.tar.gz https://dotnetcli.azureedge.net/dotnet/aspnetcore/Runtime/${ASPNET_9_RUNTIME_VERSION}/aspnetcore-runtime-${ASPNET_9_RUNTIME_VERSION}-linux-x64.tar.gz \
#   && echo "${ASPNET_8_RUNTIME_SHA_AMD64}  aspnetcore.tar.gz" | sha512sum -c - ; \
#   fi \
#   && mkdir -p /usr/share/dotnet \
#   && tar -ozxf aspnetcore.tar.gz -C /usr/share/dotnet \
